...
fn cross_validate(data: &mut FormData, extras: &HashMap<String, String>) {
    ...
    if data.oth_rate == "0%" || data.oth_rate.is_empty() {
        ...
        if v > 0.0 && !match_ratio(v / v1b, &["0.15%", "0.3%", "0.45%", "0.6%", "0%"], &mut data.oth_rate) {
...
fn build_form_data(
    ...
    if has_voting {
        ...
        let loose_fc: &[(&str, &str)] = &[
            ("val_1A", r"(?im)\b1[4A]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_1B", r"(?im)\b1[8B]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_1C", r"(?im)\b1[Cc]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_1D", r"(?im)\b1[Dd]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_2A", r"(?im)\b2[4A]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_2B", r"(?im)\b2[8B]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_2C", r"(?im)\b2[Cc]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_4A", r"(?im)\b4[Ah]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_4B", r"(?im)\b4[8B]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_4C", r"(?im)\b4[Cc]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_5A", r"(?im)\b[5S][4A]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_5B", r"(?im)\b5[8B]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_5C", r"(?im)\b5[Cc]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_6A", r"(?im)\b6[Ah,&]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_6B", r"(?im)\b6[8B]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_6C", r"(?im)\b6[Cc]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_7A", r"(?im)\b[7T][4A]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_8A", r"(?im)\b[8B][4Ah,]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_10A", r"(?im)\b10[Ah,]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_1E", r"(?im)\b[1L][Ee]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_8B", r"(?im)\b[8B][8B]\b\D*?(\d[\d,.\s]*)\s*$"),
            ("val_12B", r"(?im)\b12[8B]\b\D*?(\d[\d,.\s]*)\s*$"),
        ];
